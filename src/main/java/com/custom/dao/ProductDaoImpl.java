...
public class ProductDaoImpl extends CommonDao  implements ProductDao {
	...
	public List<ProductVO> productlist(Map<String, Object> map) {
		return getSqlSession().selectList("productList", map);
	}
	...
	public int checkStock(Map<String,Object> optionMap) {
		return getSqlSession().selectOne("checkStock", optionMap);
	}
	
	public int getOptionStock(CartVO cartVo) {
		return getSqlSession().selectOne("getOptionStock", cartVo);
	}
